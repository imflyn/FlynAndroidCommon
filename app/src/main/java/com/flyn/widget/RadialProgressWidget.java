...
/** Copyright (C) 2012 Arindam Nath (strider2023@gmail.com)
 *
...
public class RadialProgressWidget extends View
{
    ...
    private static final int HOLO_LIGHT_BLUE = 0xff33b5e5;
    private static final int HOLO_DARK_BLUE = 0xff0099cc;
    private static final int HOLO_LIGHT_PURPLE = 0xffaa66cc;
    private static final int HOLO_DARK_PURPLE = 0xff9933cc;
    private static final int HOLO_LIGHT_GREEN = 0xff99cc00;
    private static final int HOLO_DARK_GREEN = 0xff669900;
    private static final int HOLO_LIGHT_ORANGE = 0xffffbb33;
    private static final int HOLO_DARK_ORANGE = 0xffff8800;
    private static final int HOLO_LIGHT_RED = 0xffff4444;
    private static final int HOLO_DARK_RED = 0xffcc0000;
