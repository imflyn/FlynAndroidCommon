            ...
            public void onWifiEnabled()
            {
                ...
                wifiUtils.connect(ap.getScanResult(), null, new WifiCallback(context)
                {
                    ...
                    public void onNetworkConnected(WifiInfo wifiInfo)
                    {
                        ...
                        String apIpStr = String.format("%d.%d.%d.%d", new Object[]{Integer.valueOf(apIp & 0xFF), Integer.valueOf(apIp >> 8 & 0xFF), Integer.valueOf(apIp >> 16 & 0xFF), Integer.valueOf(apIp >> 24 & 0xFF)});
                        user.setIp(apIpStr);
                        user.state = 1;
