...
public class IntentUtils
{
     ...
     *            Application context
     * @param openInBrowser
     *            Should we try to open application page in web browser if Play
     ...
     * @param pitch
     *            Panorama center-of-view in degrees from -90 (look straight up)
     ...
     *            portrait mode.
     * @param mapZoom
     *            The map zoom of the map location associated with this
     ...
     *            Longitude
     * @param zoomLevel
     *            A zoom level of 1 shows the whole Earth, centered at the given
     ...
     *
     * @param scope
     *            You can restrict selection by passing required content type.
     *            Examples:
     *            <p/>
     *            <code><pre>
     ...
     *            Application context
     * @param image
     *            Image that will be used for cropping. This image is not
     ...
     *            Crop frame aspect Y
     * @param scale
     *            Scale or not cropped image if output image and cropImage frame
     *            sizes differs
