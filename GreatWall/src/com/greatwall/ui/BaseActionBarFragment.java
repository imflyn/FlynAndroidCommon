...
public abstract class BaseActionBarFragment extends FixedOnActivityResultBugFragment
{
    ...
    public void onAttach(Activity activity)
    {
        ...
        if (!(activity instanceof BaseActionBarActivity))
            throw new IllegalStateException("Activity must extends BaseActionBarActivity");

        mContext = (BaseActionBarActivity) activity;
    ...
    public BaseActionBarActivity getContext()
    {
        return this.mContext != null ? this.mContext : (BaseActionBarActivity) getActivity();
    }
