...
public abstract class DialogManager
{
    ...
    public static ProgressDialog showProgressDialog(Context context, String title, String msg, String[] buttons, DialogInterface.OnClickListener onClickListener, boolean cancelable,
    ...
    public static ProgressDialog showProgressDialog(Context context, int titleId, int msgId, int[] buttonIds, DialogInterface.OnClickListener onClickListener, boolean cancelable,
            boolean isNotAutoDismiss)
    {
        String title = null;
        if (titleId != -1)
    ...
    public static ProgressDialog showProgressDialog(Context context, int theme, String title, String msg, String[] buttons, DialogInterface.OnClickListener onClickListener, boolean cancelable,
            boolean isNotAutoDismiss)
    {
    ...
    public static ProgressDialog showProgressDialog(Context context, int theme, int titleId, int msgId, int[] buttonIds, DialogInterface.OnClickListener onClickListener, boolean cancelable,
            boolean isNotAutoDismiss)
    {
        String title = null;
        if (titleId != -1)
