package com.greatwall.ui.widget.slidingmenu;
...
import com.greatwall.ui.widget.slidingmenu.SlidingMenu.OnClosedListener;
import com.greatwall.ui.widget.slidingmenu.SlidingMenu.OnOpenedListener;
        ...
        switch (action & MotionEventCompat.ACTION_MASK)
        {
            ...
            case MotionEvent.ACTION_UP:
                if (mIsBeingDragged)
                {
                    ...
                    // final int widthWithMargin = getWidth();
                    // final float pageOffset = (float) (scrollX %
