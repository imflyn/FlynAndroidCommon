...
public abstract class AsyncTask<Params, Progress, Result>
{
    ...
    public AsyncTask()
    {
        ...
        mFuture = new FutureTask<Result>(mWorker)
        {
            ...
            protected void done()
            {
                ...
                {
                    message = sHandler.obtainMessage(MESSAGE_POST_CANCEL, new UserTaskResult<Result>(AsyncTask.this, (Result[]) null));
                ...
                message = sHandler.obtainMessage(MESSAGE_POST_RESULT, new UserTaskResult<Result>(AsyncTask.this, result));
                message.sendToTarget();
            }
        };
    }
     ...
     *                               {@link com.greatwall.ui.utils.AsyncTask.Status#RUNNING} or
     *                               {@link com.greatwall.ui.utils.AsyncTask.Status#FINISHED}.
     */
