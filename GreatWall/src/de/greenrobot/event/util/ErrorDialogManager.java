 ...
 * How to use:
 * <ol>
 * <li>Set the {@link #factory} to configure dialogs for your app, typically in
 * {@link Application#onCreate()}</li>
 * <li>Use one of {@link #attachTo(Activity)},
 * {@link #attachTo(Activity, boolean)} or
 * {@link #attachTo(Activity, boolean, Bundle)} in your Activity, typically in
 * onCreate.</li>
 * </ol>
 * 
 * For more complex mappings, you can supply your own
 * {@link ErrorDialogFragmentFactory}.
 * 
 * @author Markus
 */
public class ErrorDialogManager
{
    ...
    public static class SupportManagerFragment extends Fragment
    {
        ...
        public void onEventMainThread(ThrowableFailureEvent event)
        {
            ...
            // Execute pending commits before finding to avoid multiple error
            // fragments being shown
