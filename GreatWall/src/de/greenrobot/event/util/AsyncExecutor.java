...
/**
 * Executes an {@link RunnableEx} using a thread pool. Thrown exceptions are
 * propagated by posting failure events of any given type (default is
 * {@link ThrowableFailureEvent}).
 * 
 * @author Markus
 */
public class AsyncExecutor
{
    ...
    /**
     * Posts an failure event if the given {@link RunnableEx} throws an
     * Exception.
     */
