...
/**
 * A generic failure event, which can be used by apps to propagate thrown
 * exceptions. Also used in conjunction with {@link ErrorDialogManager}.
 */
public class ThrowableFailureEvent implements HasExecutionScope
{
     ...
     *            true indicates to the receiver that no error UI (e.g. dialog)
     *            should now displayed.
     */
