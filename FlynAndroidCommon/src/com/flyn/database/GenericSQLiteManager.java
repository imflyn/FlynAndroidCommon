...
public class GenericSQLiteManager
{
	...
	public void executeSQL(final Class<? extends GenericSQLiteOpenHelper> cls, final String sql, final Object[] sqlArgus,
	...
	public void executeSQLByTransaction(final Class<? extends GenericSQLiteOpenHelper> cls, final String sql, final Object[] sqlArgus,
			final GenericSQLiteListener genericSQLiteListener)
	{
		Runnable runnable = new Runnable()
		{
