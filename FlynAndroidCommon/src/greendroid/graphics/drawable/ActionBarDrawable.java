...
public class ActionBarDrawable extends BitmapDrawable
{
    ...
    public ActionBarDrawable(Context context, Drawable d)
    {
        ...
        this(context, d, getColorFromTheme(context, R.attr.gdActionBarItemColorNormal, Color.WHITE), getColorFromTheme(context, R.attr.gdActionBarItemColorAlt, Color.BLACK));
    }
    ...
    {
        final boolean useAlt = StateSet.stateSetMatches(DrawableStateSet.ENABLED_PRESSED_STATE_SET, stateSet) || StateSet.stateSetMatches(DrawableStateSet.ENABLED_FOCUSED_STATE_SET, stateSet);
