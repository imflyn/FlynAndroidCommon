 ...
 */
public class GDListSlidingActivity extends GDSlidingActivity
{

    private static final String LOG_TAG        = GDListSlidingActivity.class.getSimpleName();
    ...
    public GDListSlidingActivity()
    {
        super();
    }

    public GDListSlidingActivity(ActionBar.Type actionBarType)
    {
        super(actionBarType);
    }
     ...
     * 
     * @return The ListView managed by the current {@link GDListSlidingActivity}
     */
