 ...
 */
public class GDListFragment extends GDActivity
{

    private static final String LOG_TAG        = GDListFragment.class.getSimpleName();
    ...
    public GDListFragment()
    {
        super();
    }

    public GDListFragment(ActionBar.Type actionBarType)
    {
        super(actionBarType);
    }
     ...
     * 
     * @return The ListView managed by the current {@link GDListFragment}
     */
