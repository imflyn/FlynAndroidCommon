 ...
 */
public class GDListSlidingFragmentActivity extends GDSlidingFragmentActivity
{

    private static final String LOG_TAG        = GDListSlidingFragmentActivity.class.getSimpleName();
    ...
    public GDListSlidingFragmentActivity()
    {
        super();
    }

    public GDListSlidingFragmentActivity(ActionBar.Type actionBarType)
    {
        super(actionBarType);
    }
     ...
     * 
     * @return The ListView managed by the current
     *         {@link GDListSlidingFragmentActivity}
     */
