...
public class ActionBar extends LinearLayout
{
    ...
    public interface OnActionBarListener
    {
         ...
         * 
         * @param position
         *            The position of the item in the action bar.
        ...
        if (!mMerging)
        {
            ...
            switch (mType)
            {
                ...
                default:
                    ...
                    // R.string.gd_go_home));
                    // mTitleView = (TextView)
                    // findViewById(R.id.gd_action_bar_title);
                    // setTitle(mTitle);
                    break;
    ...
    /**
     * @param title
     *            The title to set to this {@link ActionBar}
     */
    ...
    public ActionBarItem addItem(ActionBarItem item, int itemId)
    {
        ...
        if (item != null)
        {
            ...
            if (mDividerDrawable != null)
            {
                ...
                final LinearLayout.LayoutParams lp = new LayoutParams(dividerWidth, android.view.ViewGroup.LayoutParams.FILL_PARENT);
            ...
            addView(itemView, new LayoutParams(size, android.view.ViewGroup.LayoutParams.FILL_PARENT));
