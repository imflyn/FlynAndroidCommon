...
public class SegmentedBar extends LinearLayout implements OnFocusChangeListener
{
    ...
    public static interface OnSegmentChangeListener
    {
         ...
         * @param clicked
         *            Whether the segment has been selected via a user click.
         */
     ...
     *            The drawable to used as a divider. Note : using a
     ...
     * 
     * @param resId
     *            The identifier of the Drawable to use.
     */
     ...
     * 
     * @param index
     *            The index of the segment to set. Client will be notified using
     *            this method of the segment change.
     */
     ...
     * 
     * @param title
     *            The title of the segment to add.
     */
    public void addSegment(String title)
    {
        ...
        if (mDividerDrawable != null && getSegmentCount() > 0)
        {
            ...
            final LinearLayout.LayoutParams lp = new LayoutParams(width, android.view.ViewGroup.LayoutParams.FILL_PARENT);
