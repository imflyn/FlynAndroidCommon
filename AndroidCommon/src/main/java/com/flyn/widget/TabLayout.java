    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        if (this.headPosition.equals("top"))
        {
            ...
            if (child1.getVisibility() != 8)
            {
                ...
                {
                    child1.measure(MeasureSpec.makeMeasureSpec(widthSize, 1073741824), MeasureSpec.makeMeasureSpec(heightSize, -2147483648));
                } else
                {
                    child1.measure(MeasureSpec.makeMeasureSpec(widthSize, 1073741824), MeasureSpec.makeMeasureSpec(lp.height, 1073741824));
                }
            ...
            if (child2.getVisibility() != 8)
            {
                child2.measure(MeasureSpec.makeMeasureSpec(widthSize, 1073741824), MeasureSpec.makeMeasureSpec(remainHeight, 1073741824));
            }
        } else if (this.headPosition.equals("bottom"))
        {
            ...
            if (child2.getVisibility() != 8)
            {
                ...
                if ((lp.height == -1) || (lp.height == -2))
                {
                    child2.measure(MeasureSpec.makeMeasureSpec(widthSize, 1073741824), MeasureSpec.makeMeasureSpec(heightSize, -2147483648));
                } else
                {
                    child2.measure(MeasureSpec.makeMeasureSpec(widthSize, 1073741824), MeasureSpec.makeMeasureSpec(lp.height, 1073741824));
                }
            ...
            if (child1.getVisibility() != 8)
            {
                child1.measure(MeasureSpec.makeMeasureSpec(widthSize, 1073741824), MeasureSpec.makeMeasureSpec(remainHeight, 1073741824));
            }
        } else if (this.headPosition.equals("left"))
        {
            ...
            if (child1.getVisibility() != 8)
            {
                ...
                {
                    child1.measure(MeasureSpec.makeMeasureSpec(widthSize, -2147483648), MeasureSpec.makeMeasureSpec(heightSize, 1073741824));
                } else
                {
                    child1.measure(MeasureSpec.makeMeasureSpec(lp.width, 1073741824), MeasureSpec.makeMeasureSpec(heightSize, 1073741824));
                }
            ...
            if (child2.getVisibility() != 8)
            {
                child2.measure(MeasureSpec.makeMeasureSpec(remainWidth, 1073741824), MeasureSpec.makeMeasureSpec(heightSize, 1073741824));
            }
        } else if (this.headPosition.equals("right"))
        {
            ...
            if (child2.getVisibility() != 8)
            {
                ...
                if ((lp.width == -1) || (lp.width == -2))
                {
                    child2.measure(MeasureSpec.makeMeasureSpec(widthSize, -2147483648), MeasureSpec.makeMeasureSpec(heightSize, 1073741824));
                } else
                {
                    child2.measure(MeasureSpec.makeMeasureSpec(lp.width, 1073741824), MeasureSpec.makeMeasureSpec(heightSize, 1073741824));
                }
            ...
            if (child1.getVisibility() != 8)
            {
                child1.measure(MeasureSpec.makeMeasureSpec(remainWidth, 1073741824), MeasureSpec.makeMeasureSpec(heightSize, 1073741824));
            }
        }
