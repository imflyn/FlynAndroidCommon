...
public class FileCache
{
     ...
     *
     * @param cacheParams 缓存参数用来初始化缓存
     */
    public FileCache(TACacheParams cacheParams)
    {
        init(cacheParams);
    }
     ...
     *
     * @param context    上下文信息
     * @param uniqueName 这个标示名字会被添加到生成緩存文件夹
     */
     ...
     *
     * @param data   byte[]的惟一标识符来存储,一般是URL
     * @param buffer 需要添加到缓存的数据
     */
    ...
    public static class TACacheParams
    {
         ...
         *
         * @param context 上下文
         * @param percent 设置分配缓存为本设备的百度比，以0.01f计算
         */
