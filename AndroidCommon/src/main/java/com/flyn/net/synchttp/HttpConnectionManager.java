...
public final class HttpConnectionManager
{
    ...
    public static HttpResponseResultStream doPostForStream(String url, boolean followRedirects, int connOrReadTimeout, Map<String, List<String>> requestHeaders, Map<String, String> postParams, String postParamsEnc) throws IOException
    {
        HttpURLConnection httpConn = null;
        InputStream input = null;
        try
    ...
    public static HttpResponseResult doPost(String url, boolean followRedirects, int connOrReadTimeout, Map<String, List<String>> requestHeaders, Map<String, String> postParams, String postParamsEnc) throws IOException
    {
    ...
    public static HttpResponseResultStream doPostForStream(String url, boolean followRedirects, int connOrReadTimeout, Map<String, List<String>> requestHeaders, InputStream postData) throws IOException
    {
        HttpURLConnection httpConn = null;
        InputStream input = null;
    ...
    private static HttpURLConnection openConnection(String url, String method, boolean followRedirects, int connOrReadTimeout, int currentRedirectCount, int currentCMWapChargePageCount, Map<String, List<String>> requestHeaders, InputStream postData) throws IOException
    {
        if (appContext == null)
        {
            ...
            if (((concatHost != null) || (proxy != null)) && (!ignoreChargePageWhenCMWap))
            {
                ...
                if ((contentType != null) && (contentType.indexOf("vnd.wap.wml") != -1))
                {
                    ...
                    try
                    {
                        ...
                        HttpURLConnection localHttpURLConnection1 = openConnection(parseURL, method, followRedirects, connOrReadTimeout, currentRedirectCount, currentCMWapChargePageCount, requestHeaders, postData);
