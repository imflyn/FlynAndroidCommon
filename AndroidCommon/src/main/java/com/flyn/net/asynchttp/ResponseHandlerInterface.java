...
public interface ResponseHandlerInterface
{
    ...
    /**
     * Notifies callback, that request was completed and is being removed from
     * thread pool
     */
     ...
     * Can set, whether the handler should be asynchronous or synchronous
     *
     * @param useSynchronousMode whether data should be handled on background Thread on UI
     *                           Thread
     */
