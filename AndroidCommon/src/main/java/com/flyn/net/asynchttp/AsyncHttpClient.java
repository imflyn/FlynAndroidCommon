 ...
 * additional parameters by passing a {@link com.flyn.net.asynchttp.RequestParams} instance, and
...
public class AsyncHttpClient
{
     ...
     * @param context         the Android Context which initiated the request.
     * @param url             the URL to send the request to.
     * @param entity          a raw {@link org.apache.http.HttpEntity} to send with the
     ...
     * @param responseHandler the response ha ndler instance that should handle the
     *                        response.
     * @return RequestHandle of future request process
     */
     ...
     * @param url             the URL to send the request to.
     * @param headers         set one-time headers for this request
     * @param params          additional DELETE parameters or files to send along with
     *                        request
     * @param responseHandler the response handler instance that should handle the response.
     * @return RequestHandle of future request process
     */
